...
const elements = {
    ...
    hideElement : {
        ...
        id7:["flexblock0","flexblock1","flexblock2","flexblock3","flexblock4","flexblock5","flexblock6",
        "flexblock7","flexblock8","flexblock9"]
    }
}
...
function updatespecies(Element,available,Elementnumber,prevElement) {
    if(Elementnumber == 0){
        ...
        let difference = Elementnumber - prevElement;
            ...
            document.getElementById(`${ButtonOncart}`).style.visibility ="hidden";
            document.getElementById(`${elements.hideElement.id1[ButtonOncart]}`).style.visibility ="hidden";
            document.getElementById(`${elements.hideElement.id3[ButtonOncart]}`).style.visibility ="hidden";
            document.getElementById(`${elements.hideElement.id4[ButtonOncart]}`).style.visibility ="hidden";
            document.getElementById(`${elements.hideElement.id5[ButtonOncart]}`).style.visibility ="hidden";
            document.getElementById(`${elements.hideElement.id6[ButtonOncart]}`).style.padding ="0px";
            document.getElementById(`${elements.hideElement.id7[ButtonOncart]}`).style.visibility ="hidden";
                ...
                document.getElementById(`${ButtonOncart}`).style.visibility ="visible";
                document.getElementById(`${elements.hideElement.id1[ButtonOncart]}`).style.visibility ="visible";
                document.getElementById(`${elements.hideElement.id3[ButtonOncart]}`).style.visibility ="visible";
                document.getElementById(`${elements.hideElement.id4[ButtonOncart]}`).style.visibility ="visible";
                document.getElementById(`${elements.hideElement.id5[ButtonOncart]}`).style.visibility ="visible";
                document.getElementById(`${elements.hideElement.id6[ButtonOncart]}`).style.padding ="15px";
                document.getElementById(`${elements.hideElement.id7[ButtonOncart]}`).style.visibility ="visible";
